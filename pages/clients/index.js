...
class Clients extends React.Component {
    ...
    render() {
        ...
        return (
            <div
                className={`container-fluid h-100 ${isNavOpen ? "table-padding-container" : "pl-3"
                    }`}
            >
                <Head>
                    <meta charSet="utf-8" />
                        ...
                        <div className="row common-pd">
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div className="tab-content tab-custom-supportsection" id="pills-tabContent">
                                            ...
                                            <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div className="clients-column-section">
                                                    <div className="clients-img-section">
                                                        <img src="/imgs/profile-pic.png" alt="Column Icon" />
                                                        <h4>Jane Doe</h4>
                                                        <h6>$1,345,889</h6>
                                                    </div>
                                                    <div className="row">
                                    ...
                                    <div className="tab-pane fade column-width-pills col-width-suportsection"
                                        id="pills-groups"
                                        role="tabpanel"

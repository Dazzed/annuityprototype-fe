  ...
  return (
    <Fragment>
      ...
      {/* <div className="col-lg-3 col-md-12 px-0 order-second" > */}
        {/* <div className={`sidebar-left ${isNavOpen ?'':''}`} style={!isNavOpen ? { width: '0 !important' } : {}}> */}
        <div className={` ${isNavOpen ?'sidebar-left':'sidebar-left-zero'}`} style={!isNavOpen ? { width: '0 !important' } : {}}>
